...
import { WorkflowCheckButton } from "@/components/workflow-check-button";
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div>
          <h1 className="font-heading text-2xl font-semibold"><Trans id="projects" /></h1>
          <p className="text-sm text-muted-foreground">
            Group related notes and tasks toward a goal.
          </p>
        </div>
        <WorkflowCheckButton apiUrl={process.env.NEXT_PUBLIC_API_URL!} />
      </div>
      ...
      <form action={createProject} className="flex flex-col sm:flex-row gap-2">
        ...
        <SubmitButton className="w-full sm:w-auto" pendingText="Creating..."><Trans id="create" /></SubmitButton>
      </form>
